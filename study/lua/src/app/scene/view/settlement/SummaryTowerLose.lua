...
local SummaryTowerLose = class("SummaryLose", SummaryLoseBase)

local Path = require("app.utils.Path")

-- --普通副本结算
function SummaryTowerLose:ctor(battleData,callback)
    SummaryTowerLose.super.ctor(self,battleData, callback)
end

function SummaryTowerLose:onEnter()
    SummaryTowerLose.super.onEnter(self)
    self:_createAnimation()
end

function SummaryTowerLose:onExit()
    SummaryTowerLose.super.onExit(self)
end

function SummaryTowerLose:_createActionNode(effect)
...
function SummaryTowerLose:_createAnimation(rootNode)
