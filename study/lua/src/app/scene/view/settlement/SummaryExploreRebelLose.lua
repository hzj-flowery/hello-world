...
local SummaryExploreLose = class("SummaryExploreLose", SummaryLoseBase)

local Path = require("app.utils.Path")

--游历叛军失败
function SummaryExploreLose:ctor(battleData, callback)
    SummaryExploreLose.super.ctor(self,battleData, callback)
end

function SummaryExploreLose:onEnter()
    SummaryExploreLose.super.onEnter(self)
    self:_createAnimation()
end

function SummaryExploreLose:onExit()
    SummaryExploreLose.super.onExit(self)
end

function SummaryExploreLose:_createActionNode(effect)
...
function SummaryExploreLose:_createAnimation(rootNode)
