...
@ccclass
export default class CarnivalActivitySingleRechargeItemCell extends ListViewCellBase {
    ...
    onCreate() {
        UIHelper.addEventListener(this.node, this._commonButtonLargeNormal._button, 'CarnivalActivitySingleRechargeItemCell', '_onTouchCallBack');
    ...
    _updateRewards(actTaskUnitData) {
        ...
        this._commonRewardListNode.setGaps(CarnivalActivitySingleRechargeItemCell.ITEM_GAP, CarnivalActivitySingleRechargeItemCell.ITEM_ADD_GAP, CarnivalActivitySingleRechargeItemCell.ITEM_OR_GAP, CarnivalActivitySingleRechargeItemCell.SCROLL_WIDTH);
    ...
    updateInfo(data) {
        ...
        if (canReceive) {
            ...
            if (functionId != 0 || activityUnitData.getQuest_type() == CustomActivityConst.CUSTOM_QUEST_TYPE_PAY_SELL_ITEM) {
