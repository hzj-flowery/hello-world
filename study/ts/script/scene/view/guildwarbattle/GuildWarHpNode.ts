...
@ccclass
export default class GuildWarHpNode extends ViewBase {
    ...
    updateInfo(hp, maxHP) {
        var percent = Math.floor(hp * 100 / maxHP) / 100;
        this._barGreen.progress = (percent);
