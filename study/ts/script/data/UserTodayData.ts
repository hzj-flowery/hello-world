...
export interface UserTodayData {
}
let schema = {};
export class UserTodayData extends BaseData {

    public static FILE_NAME = 'firstloginstate';
    ...
    public _saveData(data) {
        ...
        G_StorageManager.saveWithUser(UserTodayData.FILE_NAME, data);
    }
    public _getData() {
        G_StorageManager.setUserInfo('', G_UserData.getBase().getId());
        return G_StorageManager.loadUser(UserTodayData.FILE_NAME) || {};
    }
