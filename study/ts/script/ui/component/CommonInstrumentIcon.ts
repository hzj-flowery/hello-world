...
export default class CommonInstrumentIcon extends CommonIconBase {
    ...
    setLevel(level) {
        ...
        if (this._imageLevel == null) {
            ...
            var parenSize = (this._panelItemContent as cc.Node).getContentSize();
            imageBg.setPosition(new cc.Vec2(3-parenSize.width*0.5, 95-parenSize.height*0.5));
    ...
    setRlevel(rLevel) {
        if (this._textRlevel == null) {
            ...
            var parenSize = (this._panelItemContent as cc.Node).getContentSize();
            label.setPosition(new cc.Vec2(46-parenSize.width*0.5, 20-parenSize.height*0.5));
            this.appendUI(label);
