...
@ccclass
export default class PopupChooseEquip2 extends PopupChooseBase {
    public static path = 'common/PopupChooseEquip2';
    ...
    public onShowFinish() {
        G_SignalManager.dispatch(SignalConst.EVENT_TUTORIAL_STEP, "PopupChooseEquip2");
    }
    ...
    private _refreshList() {
        ...
        var helpFunc = PopupChooseEquipHelper['_FROM_TYPE' + this._fromType];
        ...
        if (data != null) {
            ...
            for (let i = 0; i < data.length; i++) {
                listData.push(PopupChooseEquipHelper.addEquipDataDesc(data[i], this._fromType,
