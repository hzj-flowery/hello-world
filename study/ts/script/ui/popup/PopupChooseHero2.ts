...
@ccclass
export default class PopupChooseHero2 extends PopupChooseBase {
    public static path: string = "common/PopupChooseHero2";
    ...
    public onShowFinish() {
        G_SignalManager.dispatch(SignalConst.EVENT_TUTORIAL_STEP, "PopupChooseHero2");
    }
    ...
    _updateListView(index) {
        ...
        if (data != null) {
            ...
            for (let i = 0; i < data.length; i++) {
                this._listData.push(PopupChooseHeroHelper.addHeroDataDesc(data[i], this._fromType, i));
            }
