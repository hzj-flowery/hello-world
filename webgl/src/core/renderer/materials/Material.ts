// import { AddEquation, AlwaysStencilFunc, FlatShading, FrontSide, KeepStencilOp, LessEqualDepth, NormalBlending, OneMinusSrcAlphaFactor, RGBAFormat, SrcAlphaFactor } from "../../constants";
...
// 		public precision:number; // override the renderer's default precision for this material
