...
// 			const positions = G_BufferManager.getBuffer(SY.GLID_TYPE.VERTEX,this.attributeId).sourceData;
// 			const normals = G_BufferManager.getBuffer(SY.GLID_TYPE.NORMAL,this.attributeId).sourceData;
// 			const uvs = G_BufferManager.getBuffer(SY.GLID_TYPE.UV,this.attributeId).sourceData;
