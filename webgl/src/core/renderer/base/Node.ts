...
export class Node extends Ref {
    ...
    */
     ...
     * @returns {mat4} out
     */
    protected matrix4RotateY(out, a, rad) {
        var s = Math.sin(rad);
        var c = Math.cos(rad);
        var a00 = a[0];
        var a01 = a[1];
     ...
     * @returns {mat4} out
     */
    protected matrix4RotateX(out, a, rad) {
        var s = Math.sin(rad);
        var c = Math.cos(rad);
        var a10 = a[4];
        var a11 = a[5];
    ...
    */
    ...
    protected matrix4RotateZ(out, a, rad) {
        var s = Math.sin(rad);
        var c = Math.cos(rad);
        var a00 = a[0];
        var a01 = a[1];
     ...
     * @returns {mat4} out
     */
    protected mat4Translate$2(out, a, v) {
        var x = v[0],
            y = v[1],
            z = v[2];
        var a00, a01, a02, a03;
