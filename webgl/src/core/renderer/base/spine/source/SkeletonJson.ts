        ...
        public readSkeletonData(json) {
            ...
            if (root.bones) {
                for (var i = 0; i < root.bones.length; i++) {
                    ...
                    var data = new BoneData(skeletonData.bones.length, boneMap.name, parent_5);
        ...
        public readAnimation(map, name, skeletonData) {
            ...
            if (map.events) {
                ...
                for (var i = 0; i < map.events.length; i++) {
                    ...
                    var event_6 = new Event(Utils.toSinglePrecision(this.getValue(eventMap, "time", 0)), eventData);
