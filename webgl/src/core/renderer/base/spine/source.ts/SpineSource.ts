...
(function (spine) {
    ...
    export class CurveTimeline extends {
    }
    ...
    export class AttachmentTimeline extends {
    }
    ...
    export class EventTimeline extends {

    }
    spine.EventTimeline = EventTimeline;
    export class DrawOrderTimeline extends {
...
export class TrackEntry extends {
    function TrackEntry() {
...
export class EventQueue extends {
...
export class AnimationStateAdapter extends {
...
var spine;
(function (spine) {
    export class AnimationStateData extends {
...
var spine;
(function (spine) {
    export class AssetManager extends {
...
var spine;
(function (spine) {
    export class AtlasAttachmentLoader extends {
...
var spine;
(function (spine) {
    export class ConstraintData extends {
...
var spine;
(function (spine) {
    export class EventData extends {
...
var spine;
(function (spine) {
    export class IkConstraint extends {
...
var spine;
(function (spine) {
    export class IkConstraintData extends spine.ConstraintData {
...
var spine;
(function (spine) {
    export class PathConstraint extends {
...
export class SharedAssetManager extends {
...
public sortIkConstraint(constraint) {
...
public sortPathConstraint(constraint) {
...
public sortTransformConstraint(constraint) {
    constraint.active = constraint.target.isActive() && (!constraint.data.skinRequired || (this.skin != null && spine.Utils.contains(this.skin.constraints, constraint.data, true)));
    if (!constraint.active)
        return;
...
public sortPathConstraintAttachment(skin, slotIndex, slotBone) {
...
public sortPathConstraintAttachmentWith(attachment, slotBone) {
    if (!(attachment instanceof spine.PathAttachment))
        return;
...
public getAttachmentByName(slotName, attachmentName) {
    return this.getAttachment(this.data.findSlotIndex(slotName), attachmentName);
};
public getAttachment(slotIndex, attachmentName) {
...
public getBounds(offset, size, temp) {
...
var spine;
(function (spine) {
    export class SkeletonBinary extends {
...
export class BinaryInput extends {
...
export class LinkedMesh extends {
...
var spine;
(function (spine) {
    export class SkeletonBounds extends {
...
var spine;
(function (spine) {
    export class SkeletonClipping extends {
...
var spine;
(function (spine) {
    export class SkeletonData extends {
...
var spine;
(function (spine) {
    export class SkeletonJson extends {
...
var spine;
(function (spine) {
    export class SkinEntry extends {
...
export class TextureRegion extends {
...
var spine;
(function (spine) {
    export class TextureAtlas extends {
...
export class TextureAtlasReader extends {
...
export class TextureAtlasPage extends {
...
var spine;
(function (spine) {
    export class TransformConstraint extends {
...
spine.Utils = Utils;
export class DebugUtils extends {
    function DebugUtils() {
}
...
export class TimeKeeper extends {
    function TimeKeeper() {
            this.maxDelta = 0.064;
...
export class WindowedMean extends {
...
var spine;
(function (spine) {
    export class Attachment extends {
...
var spine;
(function (spine) {
    export class JitterEffect extends {
...
var spine;
(function (spine) {
    export class SwirlEffect extends {
