...
mapTree_u.set(syGL.AttributeUniform.EMISSIVE,ShaderUseVariantType.EMISSIVE);
...
mapTree_u.set(syGL.AttributeUniform.LIGHT_PARALLEL_DIRECTION,ShaderUseVariantType.ParallelLight);
...
mapTree_u.set(syGL.AttributeUniform.LIGHT_SPOT_CENTER_DIRECTION,ShaderUseVariantType.SpotLight);
...
mapTree_u.set(syGL.AttributeUniform.VW_Mat,ShaderUseVariantType.ViewModel);
mapTree_u.set(syGL.AttributeUniform.P_Mat,ShaderUseVariantType.Projection);
...
mapTree_u.set(syGL.AttributeUniform.MAP_NORMAL_SCALE,ShaderUseVariantType.MAP_NORMAL_SCALE);
mapTree_u.set(syGL.AttributeUniform.MAP_BUMP,ShaderUseVariantType.MAP_BUMP);
mapTree_u.set(syGL.AttributeUniform.MAP_BUMP_SCALE,ShaderUseVariantType.MAP_BUMP_SCALE);
...
mapTree_u.set(syGL.AttributeUniform.W_Mat,ShaderUseVariantType.Model);
mapTree_u.set(syGL.AttributeUniform.V_Mat,ShaderUseVariantType.View);
mapTree_u.set(syGL.AttributeUniform.W_Mat_I,ShaderUseVariantType.ModelInverse);
mapTree_u.set(syGL.AttributeUniform.W_Mat_T,ShaderUseVariantType.ModelTransform);
mapTree_u.set(syGL.AttributeUniform.W_Mat_I_T,ShaderUseVariantType.ModelInverseTransform);
mapTree_u.set(syGL.AttributeUniform.PV_Mat,ShaderUseVariantType.ProjectionView);
mapTree_u.set(syGL.AttributeUniform.PV_Mat_I,ShaderUseVariantType.ProjectionViewInverse);
...
export class ShaderProgramBase {
     ...
     * @param data 数组中包含四个元素 shader那边是一个vec4
     */
     public setCustomUniformFloatArray(uniforName:syGL.AttributeUniform,data:Array<number>):void{
        var loc = getLocName(uniforName,true);
        if (this.checklocValid(this[loc])) {
            G_DrawEngine.setUniform1fv(this[loc], data);
        }
    }
