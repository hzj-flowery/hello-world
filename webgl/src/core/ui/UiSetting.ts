...
class UISetting {
    ...
    public setUI(): void {
        ...
        let light = [
            ...
            { type: 'slider', key: 'eyeX', min: -500, max: 500, change: this.render.bind(this), precision: 2, step: 1, },
            { type: 'slider', key: 'eyeY', min: -500, max: 500, change: this.render.bind(this), precision: 2, step: 1, },
            { type: 'slider', key: 'eyeZ', min: -500, max: 500, change: this.render.bind(this), precision: 2, step: 1, },
