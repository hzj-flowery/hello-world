...
function main() {
    ...
    var fogBufferArr = Shader_1.G_ShaderFactory.createBufferInfoFromArrays(fogDataArrays);
    var uniformData = {
        u_projection: {},
        u_worldView: {},
        u_texture: {},
    ...
    var modelXRotationRadians = MathUtils_1.MathUtils.degToRad(0);
    var modelYRotationRadians = MathUtils_1.MathUtils.degToRad(0);
    ...
    function drawScene(time) {
        ...
        Shader_1.G_ShaderFactory.setBuffersAndAttributes(programShader.attrSetters, fogBufferArr);
        ...
        for (var i = 0; i <= numCubes; ++i) {
            var worldViewMatrix = Matrix_1.glMatrix.mat4.translate(null, viewMatrix, [-2 + i * settings.xOff, 0, -i * settings.zOff]);
            Matrix_1.glMatrix.mat4.rotateX(worldViewMatrix, worldViewMatrix, modelXRotationRadians + i * 0.1);
            Matrix_1.glMatrix.mat4.rotateY(worldViewMatrix, worldViewMatrix, modelYRotationRadians + i * 0.1);
            uniformData.u_worldView = worldViewMatrix;
            Shader_1.G_ShaderFactory.setUniforms(programShader.uniSetters, uniformData);
            Shader_1.G_ShaderFactory.drawBufferInfo(fogBufferArr, gl.TRIANGLES);
        }
        requestAnimationFrame(drawScene);
    }
}
var FogTest = /** @class */ (function () {
    function FogTest() {
    }
    FogTest.run = function () {
        main();
    };
    return FogTest;
}());
exports.default = FogTest;
