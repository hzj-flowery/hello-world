...
function main() {
    ...
    // setup GLSL program
    var program = webglUtils.createProgramFromScripts2(gl, [vertexshader3d, fragmentshader3d]);
    ...
    function drawScene(clock) {
        ...
        for (var yy = -1; yy <= 1; ++yy) {
            for (var xx = -2; xx <= 2; ++xx) {
                var matrix = m4.translate(projectionMatrix, translation[0] + xx * spread, translation[1] + yy * spread, translation[2]);
...
var CanvasLabelTest = /** @class */ (function () {
    function CanvasLabelTest() {
    }
    CanvasLabelTest.run = function () {
        main();
    };
    return CanvasLabelTest;
}());
exports.default = CanvasLabelTest;
//# sourceMappingURL=CanvasLabelTest.js.map