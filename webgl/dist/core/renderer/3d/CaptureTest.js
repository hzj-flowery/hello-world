...
function main() {
    ...
    var cubeBufferInfor = Shader_1.G_ShaderFactory.createBufferInfoFromArrays(modelData);
    var uniforms = {
        u_matrix: {}
    };
    var translation = [0, 0, -360];
    var rotation = [MathUtils_1.MathUtils.degToRad(190), MathUtils_1.MathUtils.degToRad(40), MathUtils_1.MathUtils.degToRad(320)];
    var scale = [1, 1, 1];
    ...
    function drawScene() {
        ...
        Shader_1.G_ShaderFactory.setBuffersAndAttributes(programShader.attrSetters, cubeBufferInfor);
        // Compute the matrices
        var aspect = gl.canvas.width / gl.canvas.height;
        var projectionMatrix = Matrix_1.glMatrix.mat4.perspective(null, fieldOfViewRadians, aspect, 1, 2000);
        Matrix_1.glMatrix.mat4.translate(projectionMatrix, projectionMatrix, translation);
        Matrix_1.glMatrix.mat4.rotateX(projectionMatrix, projectionMatrix, rotation[0]);
        Matrix_1.glMatrix.mat4.rotateY(projectionMatrix, projectionMatrix, rotation[1]);
        Matrix_1.glMatrix.mat4.rotateZ(projectionMatrix, projectionMatrix, rotation[2]);
        Matrix_1.glMatrix.mat4.scale(projectionMatrix, projectionMatrix, scale);
        uniforms.u_matrix = projectionMatrix;
        Shader_1.G_ShaderFactory.setUniforms(programShader.uniSetters, uniforms);
        Shader_1.G_ShaderFactory.drawBufferInfo(cubeBufferInfor, gl.TRIANGLES);
    }
...
var CaptureTest = /** @class */ (function () {
    function CaptureTest() {
    }
    CaptureTest.run = function () {
        main();
    };
    return CaptureTest;
}());
