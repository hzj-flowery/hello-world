...
function main() {
    ...
    // setup GLSL programs
    var textureProgramInfo = webglUtils.createProgramInfo(gl, [vertexshader3d, fragmentshader3d]);
    var colorProgramInfo = webglUtils.createProgramInfo(gl, [colorvertexshader, colorfragmentshader]);
    var sphereBufferInfo = primitives.createSphereBufferInfo(gl, 1, // radius
    32, // subdivisions around
    24);
    var planeBufferInfo = primitives.createPlaneBufferInfo(gl, 20, // width
    20, // height
    1, // subdivisions across
    1);
    var cubeBufferInfo = primitives.createCubeBufferInfo(gl, 2);
    var cubeLinesBufferInfo = webglUtils.createBufferInfoFromArrays(gl, {
        position: [
            -1, -1, -1,
            1, -1, -1,
            -1, 1, -1,
    ...
    function render() {
        ...
        var lightWorldMatrix = m4.lookAt([settings.posX, settings.posY, settings.posZ], // position
        [settings.targetX, settings.targetY, settings.targetZ], // target
        [0, 1, 0]);
        var lightProjectionMatrix = settings.perspective
            ? m4.perspective(degToRad(settings.fieldOfView), settings.projWidth / settings.projHeight, 0.5, // near
            10) // far
        ...
        var cameraPosition = [settings.cameraX, settings.cameraY, 15];
        var target = [0, 0, 0];
        var up = [0, 1, 0];
        ...
        // ------ Draw the frustum ------
        {
            ...
            // infinity
            var mat = m4.multiply(lightWorldMatrix, m4.inverse(lightProjectionMatrix));
...
//# sourceMappingURL=ShaderShadowTest.js.map