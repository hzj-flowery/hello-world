    ...
    var faceInfos = [
        {
            ...
            url: 'res/skybox/2/right+x.png',
        },
        {
            target: gl.TEXTURE_CUBE_MAP_NEGATIVE_X,
            url: 'res/skybox/2/left-x.png',
        },
        {
            target: gl.TEXTURE_CUBE_MAP_POSITIVE_Y,
            url: 'res/skybox/2/up-y.png',
        },
        {
            target: gl.TEXTURE_CUBE_MAP_NEGATIVE_Y,
            url: 'res/skybox/2/down+y.png',
        },
        {
            target: gl.TEXTURE_CUBE_MAP_POSITIVE_Z,
            url: 'res/skybox/2/back-z.png',
        },
        {
            target: gl.TEXTURE_CUBE_MAP_NEGATIVE_Z,
            url: 'res/skybox/2/front+z.png',
        },
    ];
...
var skyBoxTest = /** @class */ (function () {
    ...
    skyBoxTest.run = function () {
        main();
    };
    return skyBoxTest;
}());
exports.default = skyBoxTest;
