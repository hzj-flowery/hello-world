...
var binaryPot = /** @class */ (function () {
     ...
     * @return {Array} 字节流
     */
    binaryPot.writeUTF = function (str, isGetBytes) {
        var back = [];
        var byteSize = 0;
        ...
        if (byteSize <= 0xff) {
            //写入 头 尾 
            //[a1,a2,a3,a4,a5,...,0,len]
            console.log("写入头尾--", 0, byteSize);
            return [0, byteSize].concat(back);
        }
        else {
            //写入 头 尾
            console.log("写入头尾--", byteSize >> 8, byteSize & 0xff);
     ...
     */
    binaryPot.readUTF = function (arr) {
        if (typeof arr === 'string') {
            return arr;
        }
        console.log("read----", arr);
        var UTF = '', _arr = binaryPot.init(arr);
     ...
     * @returns {Stream}
     */
    binaryPot.convertStream = function (x) {
     ...
     * @returns {*|Array}
     */
    binaryPot.toMQttString = function (str) {
        return binaryPot.writeUTF(str);
    };
    return binaryPot;
}());
;
var Stream = /** @class */ (function () {
     ...
     */
    Stream.prototype.supportArrayBuffer = function () {
    ...
    * @returns {Array} 存入的数组
    */
    Stream.baseRead = function (m, i, a) {
        var t = a ? a : [];
     ...
     * @returns {*|Stream}
     */
    Stream.prototype.parse = function (x) {
     ...
     */
    Stream.prototype.readInt = function () {
        if (this.check()) {
            return -1;
        }
        var end = "";
     ...
     */
    Stream.prototype.read = function (bytesArray) {
        if (this.check()) {
            return -1;
        }
        if (bytesArray) {
            return Stream.baseRead(this, bytesArray.length | 0, bytesArray);
        }
        else {
     ...
     */
    Stream.prototype.readUTF = function () {
     ...
     */
    Stream.prototype.write = function (_byte) {
        var b = _byte;
     ...
     */
    Stream.prototype.writeChar = function (v) {
        if (+v != v) {
     ...
     * @return {Array} 缓冲区
     */
    Stream.prototype.writeUTF = function (str) {
     ...
     */
    Stream.prototype.toComplements = function () {
     ...
     */
    Stream.prototype.getBytesArray = function (isCom) {
        if (isCom) {
