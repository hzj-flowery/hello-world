...
exports.Shader = exports.G_ShaderFactory = exports.ShaderData = void 0;
var GLEnums_1 = require("./core/renderer/gfx/GLEnums");
...
var ShaderFactory = /** @class */ (function () {
   ...
   */
    ...
    ShaderFactory.prototype.createUniformSetter = function (uniformInfo, shaderData) {
        var gl = this._gl;
        var program = shaderData.spGlID;
        var textureUnit = shaderData.textureUnit;
